...
<head>
    <meta charset="UTF-8">
    <title>Tutorías - Sistema de Tutorías</title>
</head>
...
<table border="1" cellpadding="6" cellspacing="0">
    ...
    <?php foreach ($tutorias as $t): ?>
        ...
        <tr>
            ...
            <td>
                <?= htmlspecialchars($t['hora_inicio']) ?>
                -
                <?= htmlspecialchars($t['hora_fin']) ?>
            </td>

            <td>
                <?= htmlspecialchars($t['modalidad']) ?>
            </td>
            ...
            <td>
                ...
                <a href="tutorias_eliminar.php?id=<?= $t['id_tutoria'] ?>"
